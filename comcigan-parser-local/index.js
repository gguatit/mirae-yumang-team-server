...
class Timetable {
  ...
  _getClassTimetable(codeConfig, grade, classNumber) {
    ...
    // Define globals that the comcigan JS code may reference without declaration
    const scriptWithGlobals = 'var numberPart="",분리,강의실="",속성="";\n' + script;

    /** DEAD: Sorry about using eval() **/
    const res = eval(scriptWithGlobals);
